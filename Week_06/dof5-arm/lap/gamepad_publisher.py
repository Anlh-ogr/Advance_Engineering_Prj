...
class GamePadPublisher(Node):
    def __init__(self):
        ...
        # khoi tao servo
        self.servo1, self.servo2, self.servo3, self.servo4, self.servo5 = 1500, 1500, 1500, 1500, 1500
        # nut gamepad
        self.btn_x, self.btn_y, self.btn_b, self.btn_a, self.dpad_y, self.btn_tl = 0, 0, 0, 0, 0, 0
        # trang thai nut truoc do
        self.prev_btn_x, self.prev_btn_y, self.prev_btn_b, self.prev_btn_a, self.prev_dpad_y, self.prev_btn_tl = 0, 0, 0, 0, 0, 0
